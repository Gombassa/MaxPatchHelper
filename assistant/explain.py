...
def detect_m4l_context(query_text, domain=None):
    ...
    m4l_keywords = ["live.", "m4l", "lom", "live api", "tempo", "track", "clip", "observer", "remote~", "max for live", "live device"]
...
def explain_query(query_text, domain=None, version="8", model=EXPLAIN_MODEL, results_count=3, callback=None, stream_to_stdout=False, stop_event=None):
    ...
    # Build user prompt — query concatenated separately to avoid .format() injection
    user_prompt = (
